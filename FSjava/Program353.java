...
class Program353
{
    public static void main(String arg[]) throws Exception
    {
        ...
        while((iRet=fiobj.read(Header,0,100))>0)   //badli madhla pani sampat nahi toparyant read karaycha and store it into byte array Header
        {
