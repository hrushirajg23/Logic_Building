//Accept N numbers from user and count number of even no.s and return the count

//Worst case: Array does not contain any even elements
//Best case: All elements of array are even
...
int main()
{
    ...
    int iRet=EvenCount(ptr,iCount);  //Display(100,4)   //passing address and no. of elements to the function
    printf("\nThe Count of even numbers is: %d",iRet);
