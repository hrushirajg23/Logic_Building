...
void OddDisplay(int *Arr,int iSize)
{
    ...
    {
        if((Arr[iCnt]%2)!=0)    //internally considered as *(Arr+iCnt) //Arr jyala point kartoy , tya address la dereference kela ki ,ji value milte tila check karaycha if it is Odd
        {
...
int main()
{
    ...
    OddDisplay(ptr,iCount);  //Display(100,4)   //passing address and no. of elements to the function
